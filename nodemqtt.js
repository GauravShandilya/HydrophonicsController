 ...
 // var client = mqtt.connect('mqtt://test.mosquitto.org');
  client.on('connect', function(){ // when connected
    // subscribe to a topic
      ...
      var jsonStr = JSON.parse(message) //Converted in to JSON objec
      jsonStr.CreatedAt = new Date();   // Added CreatedAt to get time details.
      console.log("mongodb insert string :"+JSON.stringify(jsonStr))
